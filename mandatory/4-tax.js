...
function calculateSalesTax(taxPrice) {
  return taxPrice * 1.20
}
...
function addTaxAndFormatCurrency(taxPrice) {
  let salesWithTax=calculateSalesTax(taxPrice)
  return "£" + salesWithTax.toFixed(2)
