...
function calculateSalesTax(price) {
  ...
  var totalIncludingTax = percent + price;
...
function addTaxAndFormatCurrency(price) {
  let percentageOfPrice = price * 0.2;
  let totalIncludingTax2 = price + percentageOfPrice;
  let decimal = totalIncludingTax2.toFixed(2);
  return "£" + decimal;
}
