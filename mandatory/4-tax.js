...
function calculateSalesTax(money) {
  let salesTax = money * 0.20;
  let totalPrice = money + salesTax;
  return totalPrice;
}
...
function addTaxAndFormatCurrency(money) {
  let totalPrice = calculateSalesTax(money);
