...
function calculateSalesTax(preTaxPrice) {
  return preTaxPrice *= 1.2;
}
...
function addTaxAndFormatCurrency(preTaxPrice) {
  return "£" + calculateSalesTax(preTaxPrice).toFixed(2);
}
