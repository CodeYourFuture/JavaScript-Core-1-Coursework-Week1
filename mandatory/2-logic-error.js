...
test("getWordLength returns the length of a word", () => {
  expect(getWordLength("Turtles")).toEqual(7);
});

test("getWordLength returns the length of a sentence", () => {
  expect(getWordLength("A wild sentence appeared!")).toEqual(25);
});
