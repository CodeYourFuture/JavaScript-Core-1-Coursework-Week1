...
function shakeBall() {
  ...
  //  seenAnswers = ["Very positive", "It is certain.", "Without a doubt.", "Yes - definitely.", "You may rely on it.", "As I see it, yes.", "Most likely.", "Outlook good.", "Yes.", "Signs point to yes.", "Reply hazy, try again.", "Ask again later.", "Better not tell you now.", "Cannot predict now.", "Concentrate and ask again.", "Don't count on it.", "My reply is no.", "My sources say no.", "Outlook not so good.", "Very doubtful."];
  //  let randomNumber = Math.floor(Math.random() * seenAnswers.length);
  //  return seenAnswers[randomNumber];

  let veryPositiveAnswers = ["It is certain.","It is decidedly so.", "Without a doubt.", "Yes - definitely.", "You may rely on it."];
  let positiveAnswers = ["As I see it, yes.", "Most likely.", "Outlook good.", "Yes.", "Signs point to yes."];
  let negativeAnswers = ["Reply hazy, try again.", "Ask again later.", "Better not tell you now.", "Cannot predict now.", "Concentrate and ask again."];
  let veryNegativeAnswers = ["Don't count on it.", "My reply is no.", "My sources say no.", "Outlook not so good.", "Very doubtful."];

  let randomNumber = Math.floor(Math.random() * veryPositiveAnswers.length);
 
    let randomAnswer = [
      veryPositiveAnswers[randomNumber],
      positiveAnswers[randomNumber],
      negativeAnswers[randomNumber],
      veryNegativeAnswers[randomNumber],
    ];

  let randomNumber2 = Math.floor(Math.random() * randomAnswer.length);
  console.log("The ball has shaken!");
  return randomAnswer[randomNumber2];
}
