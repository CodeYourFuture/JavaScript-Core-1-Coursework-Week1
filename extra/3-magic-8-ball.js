...
let VeryPositive = [
 ...
 function shakeBall() {
  ...
  const answerMood=  Math.floor(Math.random() * answers.length);
  const randomAnswer=  Math.floor(Math.random() * answers[answerMood].length);
  return answers[answerMood][randomAnswer];
