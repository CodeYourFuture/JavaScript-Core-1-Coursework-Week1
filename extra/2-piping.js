...
// The code isn't as readable 
function badValue(){let totalPrice = (startingValue+10)*2;return `£${totalPrice}`;}

let badCode = badValue(startingValue);

/* BETTER PRACTICE */
function goodValue(){
    let totalPrice = (startingValue+10)*2;
    return `£${totalPrice}`;
}

let goodCode = goodValue(startingValue);
