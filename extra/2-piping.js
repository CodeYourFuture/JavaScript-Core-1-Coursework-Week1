...
// The code is hard to read and would not be easy to understand for someone new to the code.
...
const addFunc = add(startingValue, 10); // 12
const multiplyFunc = multiply(2, addFunc);

let goodCode = format(multiplyFunc);
