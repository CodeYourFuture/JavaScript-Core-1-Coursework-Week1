...
// This line of code is quite confusing to read and also tricky to write due to the number of brackets
let badCode = format(multiply(add(startingValue, 10), 2));

/* BETTER PRACTICE */
let totalOfNums = add(startingValue, 10);
let product = multiply(totalOfNums, 2);
