...
let result =multiply(2,add(startingValue,10));
let badCode =format(result);
/* BETTER PRACTICE */
let result1 = add(10,startingValue);
let result2 = multiply(2,result1);
let goodCode =format(result2);
