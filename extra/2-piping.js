...
function format(num4) {
  textNum = num4.toString();
  return `£${textNum}`;
}
const startingValue = 2;

// Why can this code be seen as bad practice? Comment your answer.
let badCode = "£24"; //!empty value and no close tag !
/* BETTER PRACTICE */
let goodCode = "£24"; //Add text to execute

/* ======= TESTS - DO NOT MODIFY ===== 
There are some Tests in this file that will help you work out if your code is working.

To run these tests type `npm run extraTo run the tests for just this one file, type 
`npm run extra-tests -- --testPathPattern 2-piping` into your terminal
