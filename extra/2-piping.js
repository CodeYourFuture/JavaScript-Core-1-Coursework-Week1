...
// MY COMMENT: This practice is not good as everything is in one line and hard to understand. 

/* BETTER PRACTICE */
let resultAdd = add(startingValue, 10);

let resultMultiply = multiply(resultAdd, 2)

let goodCode = format(resultMultiply);
