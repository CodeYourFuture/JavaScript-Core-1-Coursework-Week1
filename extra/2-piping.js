...
let goodCode = format(format //output of multiply by adding £ before the number
    multiply( // multiply the return of Add function by 2
        add(startingValue, 10), // add 2 to startingValue
        2));
