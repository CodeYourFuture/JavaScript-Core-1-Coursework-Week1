...
function convertToBRL(pound) {
  // const convertablePound = pound - (1 / pound) * 100; also same as
  const convertablePound = pound - (pound * 0.01);
  const convertedPoundToBRL = convertablePound * 5.7;
  const convertedToNumber = Number(convertedPoundToBRL.toFixed(2));
