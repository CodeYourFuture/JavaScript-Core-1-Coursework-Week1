...
function convertToUSD(inPounds) {
  return inPounds * 1.4;
}

let value = convertToUSD(32);
...
function convertToBRL(inPounds) {
  let fee = inPounds - (0.01 * inPounds);
  return Math.round((fee * 5.7)* 100)/100;
}

let newValue = convertToBRL(30);

console.log(`Amount is ${newValue} Brazilian real`);
