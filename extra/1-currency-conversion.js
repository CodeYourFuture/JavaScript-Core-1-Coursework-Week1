...
function convertToUSD(amountToPounds) {
 return  amountToPounds * 1.4 ;

}

let value = convertToUSD(30);
console.log(value);
/*
  CURRENCY CONVERSION
  ===================
...
function convertToBRL(amountInBrl) {
let  exchangeRate = amountInBrl - (0.01 * amountInBrl);
return Math.round(exchangeRate * 5.7)  / 100;
}
let value2 = convertToBRL(30);
console.log (value2);
