...
function convertToUSD(amount) {
  var amount_in_USD = amount * 1.4;
  return parseFloat(amount_in_USD.toFixed(2));
}
...
function convertToBRL(amount) {
  var amount_fee_excluded = amount - amount * 0.01;
  var amount_in_BRL = amount_fee_excluded * 5.7;
  return parseFloat(amount_in_BRL.toFixed(2));
}
