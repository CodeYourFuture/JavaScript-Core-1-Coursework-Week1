...
function convertToUSD(exchangeCurrency) {
  return exchangeCurrency * 1.4;
}
/*
  CURRENCY CONVERSION
  ===================
...
function convertToBRL(brazilianGbp) {
  var tradeFee = brazilianGbp * 5.7 * 0.99;
  return Number(tradeFee.toFixed(2));
}
/* ======= TESTS - DO NOT MODIFY ===== 
