...
function convertToBRL(rate) {
  var totalExchange = (rate*0.99)*5.7;
  return Number(totalExchange.toFixed(2));
}

/*function percentageConvert(rate){
  var totalExchange = convertToBRL(rate);
  var totalPercent = totalExchange;
