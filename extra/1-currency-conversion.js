...
function convertToUSD(priceInPound) {
  /*let priceInDollar = priceInPound * 1.4;*/
...
To run these tests type `npm run extraTo run the tests for just this one file, type `npm test -- --testPathPattern 1-currency-conversion` into your terminal
