...
function convertToUSD(amountInUs) {
    let convertedToGB = Number((amountInUs * 1.4).toFixed(1));
...
function convertToBRL(amountInBRL) {
    ...
    let convertedToGB = Number((amountInBRL * 5.70))
    let remainAmountGB = convertedToGB - (convertedToGB * 0.01);
    return remainAmountGB;
