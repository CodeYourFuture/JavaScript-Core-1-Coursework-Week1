...
function convertToUSD(moneyInPounds) {
  let usd = moneyInPounds * 1.4
  return usd
}
...
function convertToBRL(moneyInReal) {
  
  let brlPlusFee = ((moneyInReal * .99) *5.7).toFixed(2);
  return parseFloat(brlPlusFee)
}
