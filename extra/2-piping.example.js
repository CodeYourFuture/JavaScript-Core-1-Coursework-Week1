...
// This is hard to read for humans looking at the code
var badCode = format(multiply(add(startingValue, 10), 2));

/* BETTER PRACTICE */

var startPlus10 = add(startingValue, 10);
var startPlus10By2 = multiply(startPlus10, 2);
var price = format(startPlus10By2);
var goodCode = price;
